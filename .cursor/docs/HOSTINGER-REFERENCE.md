...
**Profile root:** D:\\Hermes\\projects\\JonBeatz.dev  
...
| `JONBEATZ.DEV_DOMAIN` | Live domain for this project |
| `JONBEATZ.DEV_WEB_ROOT` | Remote public web root |
| `JONBEATZ.DEV_APP_ROOT` | Node.js app root (if applicable) |
