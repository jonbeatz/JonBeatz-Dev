# Start Project - JonBeatz.dev Initialization
...
Run from the **JonBeatz.dev** profile root:
...
```powershell
npm run draven:speak -- "JonBeatz.dev online Jon. Draven standing by. Ready when you are."
```
